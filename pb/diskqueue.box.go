...
type DiskqueueGrpcClient interface {
	...
	Subscribe(ctx context.Context, in *SubscribeRequest, opts ...tropt.CallOption) (*SubscribeReply, error)
	Cancel(ctx context.Context, in *CancelRequest, opts ...tropt.CallOption) (*CancelReply, error)
	Pull(ctx context.Context, in *PullRequest, opts ...tropt.CallOption) (*PullReply, error)
	KeepAlive(ctx context.Context, in *KeepAliveRequest, opts ...tropt.CallOption) (Diskqueue_KeepAliveClient, error)
...
func (c *diskqueueGrpcClient) Subscribe(ctx context.Context, in *SubscribeRequest, opts ...tropt.CallOption) (*SubscribeReply, error) {
...
func (c *diskqueueGrpcClient) Cancel(ctx context.Context, in *CancelRequest, opts ...tropt.CallOption) (*CancelReply, error) {
	out := new(CancelReply)
...
func (c *diskqueueGrpcClient) KeepAlive(ctx context.Context, in *KeepAliveRequest, opts ...tropt.CallOption) (Diskqueue_KeepAliveClient, error) {
	stream, err := c.cc.NewStream(ctx, DiskqueueGrpcServiceDesc, 1, "/diskqueue.Diskqueue/KeepAlive", opts...)
	if err != nil {
		return nil, err
	}
...
type DiskqueueClient interface {
	...
	Subscribe(ctx context1.Context, in *SubscribeRequest, opts ...grpc1.CallOption) (*SubscribeReply, error)
	Cancel(ctx context1.Context, in *CancelRequest, opts ...grpc1.CallOption) (*CancelReply, error)
	Pull(ctx context1.Context, in *PullRequest, opts ...grpc1.CallOption) (*PullReply, error)
	KeepAlive(ctx context1.Context, in *KeepAliveRequest, opts ...grpc1.CallOption) (Diskqueue_KeepAliveClient, error)
...
func (c *diskqueueClient) Subscribe(ctx context1.Context, in *SubscribeRequest, opts ...grpc1.CallOption) (*SubscribeReply, error) {
	out := new(SubscribeReply)
	err := c.cc.Invoke(ctx, "/diskqueue.Diskqueue/Subscribe", in, out, opts...)
	if err != nil {
		return nil, err
...
func (c *diskqueueClient) Cancel(ctx context1.Context, in *CancelRequest, opts ...grpc1.CallOption) (*CancelReply, error) {
	out := new(CancelReply)
	err := c.cc.Invoke(ctx, "/diskqueue.Diskqueue/Cancel", in, out, opts...)
	if err != nil {
		return nil, err
...
func (c *diskqueueClient) KeepAlive(ctx context1.Context, in *KeepAliveRequest, opts ...grpc1.CallOption) (Diskqueue_KeepAliveClient, error) {
...
type DiskqueueServer interface {
	...
	Subscribe(context1.Context, *SubscribeRequest) (*SubscribeReply, error)
	Cancel(context1.Context, *CancelRequest) (*CancelReply, error)
...
func _Diskqueue_Subscribe_Handler(srv interface{}, ctx context1.Context, dec func(interface{}) error, interceptor grpc1.UnaryServerInterceptor) (interface{}, error) {
...
func _Diskqueue_Cancel_Handler(srv interface{}, ctx context1.Context, dec func(interface{}) error, interceptor grpc1.UnaryServerInterceptor) (interface{}, error) {
...
func _Diskqueue_KeepAlive_Handler(srv interface{}, stream grpc1.ServerStream) error {
